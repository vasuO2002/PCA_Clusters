...
def calculate_metrics(df, display_desc, start_date, end_date, frequency):
    ...
    inactive_products_per_period = resampled_df['product_id'].count() - active_products_per_period
    ...
    result_df = pd.DataFrame({
        ...
        'inactive_products': inactive_products_per_period.values,
...
async def cohort_analysis(payload: RequestPayload):
    ...
    json_payload = {
        ...
        "inactive_products": result_df['inactive_products'].tolist(),
